...
extern const u8 gText_GOGOGGLES[];
extern const u8 gText_PPUP[];
extern const u8 gText_EXPSHARE[];
extern const u8 gText_ACROBIKE[];
extern const u8 gText_MACHBIKE[];
extern const u8 gText_SUPERROD[]; 
extern const u8 gText_TM01_FOCUS_PUNCH[];
extern const u8 gText_TM02_DRAGON_CLAW[];
extern const u8 gText_TM03_WATER_PULSE[];
extern const u8 gText_TM04_CALM_MIND[];
extern const u8 gText_TM05_ROAR[];
extern const u8 gText_TM06_TOXIC[];
extern const u8 gText_TM07_HAIL[];
extern const u8 gText_TM08_BULK_UP[];
extern const u8 gText_TM09_BULLET_SEED[];
extern const u8 gText_TM10_HIDDEN_POWER[];
extern const u8 gText_TM11_SUNNY_DAY[];
extern const u8 gText_TM12_TAUNT[];
extern const u8 gText_TM13_ICE_BEAM[];
extern const u8 gText_TM14_BLIZZARD[];
extern const u8 gText_TM15_HYPER_BEAM[];
extern const u8 gText_TM16_LIGHT_SCREEN[];
extern const u8 gText_TM17_PROTECT[];
extern const u8 gText_TM18_RAIN_DANCE[];
extern const u8 gText_TM19_GIGA_DRAIN[];
extern const u8 gText_TM20_SAFEGUARD[];
extern const u8 gText_TM21_FRUSTRATION[];
extern const u8 gText_TM22_SOLAR_BEAM[];
extern const u8 gText_TM23_IRON_TAIL[];
extern const u8 gText_TM24_THUNDERBOLT[];
extern const u8 gText_TM25_THUNDER[];
extern const u8 gText_TM26_EARTHQUAKE[];
extern const u8 gText_TM27_RETURN[];
extern const u8 gText_TM28_DIG[];
extern const u8 gText_TM29_PSYCHIC[];
extern const u8 gText_TM30_SHADOW_BALL[];
extern const u8 gText_TM31_BRICK_BREAK[];
extern const u8 gText_TM32_DOUBLE_TEAM[];
extern const u8 gText_TM33_REFLECT[];
extern const u8 gText_TM34_SHOCK_WAVE[];
extern const u8 gText_TM35_FLAMETHROWER[];
extern const u8 gText_TM36_SLUDGE_BOMB[];
extern const u8 gText_TM37_SANDSTORM[];
extern const u8 gText_TM38_FIRE_BLAST[];
extern const u8 gText_TM39_ROCK_TOMB[];
extern const u8 gText_TM40_AERIAL_ACE[];
extern const u8 gText_TM41_TORMENT[];
extern const u8 gText_TM42_FACADE[];
extern const u8 gText_TM43_SECRET_POWER[];
extern const u8 gText_TM44_REST[];
extern const u8 gText_TM45_ATTRACT[];
extern const u8 gText_TM46_THIEF[];
extern const u8 gText_TM47_STEEL_WING[];
extern const u8 gText_TM48_SKILL_SWAP[];
extern const u8 gText_TM49_SNATCH[];
extern const u8 gText_TM50_OVERHEAT[];
extern const u8 gText_ITEM_HM01_CUT[];
extern const u8 gText_HM02_FLY[];
extern const u8 gText_HM03_SURF[];
extern const u8 gText_HM04_STRENGTH[];
extern const u8 gText_HM05_FLASH[];
extern const u8 gText_HM06_ROCK_SMASH[];
extern const u8 gText_HM07_WATERFALL[];
extern const u8 gText_HM08_DIVE[];
extern const u8 gText_AMATEUR_OPEN[];
extern const u8 gText_RIN_INVITATIONAL[];
extern const u8 gText_RIN_RUMBLE[];
extern const u8 gText_ACE_LEAGUE_I[];
extern const u8 gText_ACE_LEAGUE_II[];
extern const u8 gText_ELITE_SERIES[];
extern const u8 gText_MASTER_SERIES[];
extern const u8 gText_GRAND_MASTER_SERIES[];
