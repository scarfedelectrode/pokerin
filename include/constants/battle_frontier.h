...
//Rin Laby Modes				   
#define LABYRINTH_AMATEUR		   0
#define LABYRINTH_INVITATIONAL	   1
#define LABYRINTH_RUMBLE		   2
#define LABYRINTH_ACE			   3
#define LABYRINTH_ACEII			   4
#define LABYRINTH_ELITE			   5
#define LABYRINTH_MASTER		   6
#define LABYRINTH_GRANDMASTER	   7
...
#define EXCHANGE_CORNER_ODDITY_CLERK	 4
#define EXCHANGE_CORNER_TMHM_CLERK	 	 5
#define EXCHANGE_CORNER_TOURNY_CLERK	 6
