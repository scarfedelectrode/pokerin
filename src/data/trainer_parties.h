s32 GetHighestLevelInPlayerParty1(void)
{
    s32 highestLevel1 = 0;
    s32 i;
...
static const struct TrainerMonItemCustomMoves sParty_Sawyer1[] = {
    ...
    .moves = {MOVE_SWORDS_DANCE, MOVE_BATON_PASS, MOVE_DOUBLE_EDGE, MOVE_ROCK_SLIDE}
    },
    {
    .iv = 0,
    .lvl = 2,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_EARTHQUAKE, MOVE_ICE_BEAM, MOVE_ROCK_SLIDE, MOVE_DOUBLE_EDGE}
    },
    {
    .iv = 0,
    .lvl = 2,
    ...
    .moves = {MOVE_TOXIC, MOVE_ENCORE, MOVE_REST, MOVE_SLEEP_TALK}
    },
    {
    .iv = 0,
    .lvl = 2,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_BULK_UP, MOVE_HI_JUMP_KICK, MOVE_EARTHQUAKE, MOVE_ROCK_SLIDE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_GruntAquaHideout1[] = {
    ...
    .heldItem = ITEM_CHOICE_BAND,
    .moves = {MOVE_DOUBLE_EDGE, MOVE_SHADOW_BALL, MOVE_FACADE, MOVE_QUICK_ATTACK}
    },
    {
    .iv = 0,
    .lvl = 2,
    ...
    .heldItem = ITEM_CHOICE_BAND,
    .moves = {MOVE_DOUBLE_EDGE, MOVE_BRICK_BREAK, MOVE_SHADOW_BALL, MOVE_TRICK}
    },
    {
    .iv = 0,
    .lvl = 2,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_DOUBLE_EDGE, MOVE_FLAMETHROWER, MOVE_WISH, MOVE_PROTECT}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_GruntAquaHideout2[] = {
    ...
    .heldItem = ITEM_CHOICE_BAND,
    .moves = {MOVE_DOUBLE_EDGE, MOVE_AERIAL_ACE, MOVE_STEEL_WING, MOVE_QUICK_ATTACK}
    },
    {
    .iv = 0,
    .lvl = 2,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SLUDGE_BOMB, MOVE_BODY_SLAM, MOVE_DIG, MOVE_AERIAL_ACE}
    },
    {
    .iv = 0,
    .lvl = 2,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_BODY_SLAM, MOVE_AERIAL_ACE, MOVE_ANCIENT_POWER, MOVE_SOFT_BOILED}
    },
    {
    .iv = 0,
    .lvl = 2,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_HEADBUTT, MOVE_ROCK_SLIDE, MOVE_BRICK_BREAK, MOVE_DRAGON_DANCE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_GruntAquaHideout3[] = {
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SLUDGE_BOMB, MOVE_EARTHQUAKE, MOVE_FLAMETHROWER, MOVE_NONE}
    },
    {
    .iv = 0,
    .lvl = 2,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SUNNY_DAY, MOVE_SOLAR_BEAM, MOVE_HIDDEN_POWER, MOVE_SYNTHESIS}
    },
    {
    .iv = 0,
    .lvl = 2,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_DOUBLE_EDGE, MOVE_SHADOW_BALL, MOVE_BULK_UP, MOVE_SLACK_OFF}
    },
    {
    .iv = 0,
    .lvl = 2,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_DOUBLE_EDGE, MOVE_SHADOW_BALL, MOVE_WISH, MOVE_PROTECT}
    },
    {
    .iv = 0,
    .lvl = 2,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_ROCK_SLIDE, MOVE_EARTHQUAKE, MOVE_BRICK_BREAK, MOVE_DRAGON_DANCE}
    },
    {
    .iv = 0,
    .lvl = 2,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_HYDRO_PUMP, MOVE_ICE_BEAM, MOVE_FIRE_BLAST, MOVE_NONE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_GruntAquaHideout4[] = {
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_STUN_SPORE, MOVE_MORNING_SUN, MOVE_PSYCHIC, MOVE_GIGA_DRAIN}
    },
    {
    .iv = 0,
    .lvl = 2,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_PSYCHIC, MOVE_SLEEP_POWDER, MOVE_GIGA_DRAIN, MOVE_NONE}
    },
    {
    .iv = 0,
    .lvl = 2,
