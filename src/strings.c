...
const u8 gText_5BP[] = _("  5RC");
const u8 gText_10BP[] = _("10RC");
const u8 gText_15BP[] = _("15RC");
...
const u8 gText_KissPoster16BP[] = _("KISS POSTER{CLEAR_TO 0x5E}16RC");
const u8 gText_KissCushion32BP[] = _("KISS CUSHION{CLEAR_TO 0x5E}32RC");
const u8 gText_SmoochumDoll32BP[] = _("SMOOCHUM DOLL{CLEAR_TO 0x5E}32RC");
const u8 gText_TogepiDoll48BP[] = _("TOGEPI DOLL{CLEAR_TO 0x5E}48RC");
const u8 gText_MeowthDoll48BP[] = _("MEOWTH DOLL{CLEAR_TO 0x5E}48RC");
const u8 gText_ClefairyDoll48BP[] = _("CLEFAIRY DOLL{CLEAR_TO 0x5E}48RC");
const u8 gText_DittoDoll48BP[] = _("DITTO DOLL{CLEAR_TO 0x5E}48RC");
const u8 gText_CyndaquilDoll80BP[] = _("CYNDAQUIL DOLL{CLEAR_TO 0x5E}80RC");
const u8 gText_ChikoritaDoll80BP[] = _("CHIKORITA DOLL{CLEAR_TO 0x5E}80RC");
const u8 gText_TotodileDoll80BP[] = _("TOTODILE DOLL{CLEAR_TO 0x5E}80RC");
const u8 gText_LaprasDoll128BP[] = _("LAPRAS DOLL{CLEAR_TO 0x58}128RC");
const u8 gText_SnorlaxDoll128BP[] = _("SNORLAX DOLL{CLEAR_TO 0x58}128RC");
const u8 gText_VenusaurDoll256BP[] = _("VENUSAUR DOLL{CLEAR_TO 0x58}256RC");
const u8 gText_CharizardDoll256BP[] = _("CHARIZARD DOLL{CLEAR_TO 0x58}256RC");
const u8 gText_BlastoiseDoll256BP[] = _("BLASTOISE DOLL{CLEAR_TO 0x58}256RC");
const u8 gText_Protein1BP[] = _("PROTEIN{CLEAR_TO 0x64}1RC");
const u8 gText_Calcium1BP[] = _("CALCIUM{CLEAR_TO 0x64}1RC");
const u8 gText_Iron1BP[] = _("IRON{CLEAR_TO 0x64}1RC");
const u8 gText_Zinc1BP[] = _("ZINC{CLEAR_TO 0x64}1RC");
const u8 gText_Carbos1BP[] = _("CARBOS{CLEAR_TO 0x64}1RC");
const u8 gText_HpUp1BP[] = _("HP UP{CLEAR_TO 0x64}1RC");
const u8 gText_Leftovers48BP[] = _("LEFTOVERS{CLEAR_TO 0x5E}8RC");
const u8 gText_WhiteHerb48BP[] = _("WHITE HERB{CLEAR_TO 0x5E}8RC");
const u8 gText_QuickClaw48BP[] = _("QUICK CLAW{CLEAR_TO 0x5E}8RC");
const u8 gText_MentalHerb48BP[] = _("MENTAL HERB{CLEAR_TO 0x5E}8RC");
const u8 gText_BrightPowder64BP[] = _("BRIGHTPOWDER{CLEAR_TO 0x5E}8RC");
const u8 gText_ChoiceBand64BP[] = _("CHOICE BAND{CLEAR_TO 0x5E}8RC");
const u8 gText_KingsRock64BP[] = _("KING'S ROCK{CLEAR_TO 0x5E}8RC");
const u8 gText_FocusBand64BP[] = _("FOCUS BAND{CLEAR_TO 0x5E}8RC");
const u8 gText_ScopeLens64BP[] = _("SCOPE LENS{CLEAR_TO 0x5E}8RC");
const u8 gText_Softboiled16BP[] = _("SOFTBOILED{CLEAR_TO 0x4E}3RC");
const u8 gText_SeismicToss24BP[] = _("SEISMIC TOSS{CLEAR_TO 0x4E}5RC");
const u8 gText_DreamEater24BP[] = _("DREAM EATER{CLEAR_TO 0x4E}5RC");
const u8 gText_MegaPunch24BP[] = _("MEGA PUNCH{CLEAR_TO 0x4E}5RC");
const u8 gText_MegaKick48BP[] = _("MEGA KICK{CLEAR_TO 0x4E}10RC");
const u8 gText_BodySlam48BP[] = _("BODY SLAM{CLEAR_TO 0x4E}10RC");
const u8 gText_RockSlide48BP[] = _("ROCK SLIDE{CLEAR_TO 0x4E}10RC");
const u8 gText_Counter48BP[] = _("COUNTER{CLEAR_TO 0x4E}10RC");
const u8 gText_ThunderWave48BP[] = _("THUNDER WAVE{CLEAR_TO 0x4E}10RC");
const u8 gText_SwordsDance48BP[] = _("SWORDS DANCE{CLEAR_TO 0x4E}10RC");
const u8 gText_DefenseCurl16BP[] = _("DEFENSE CURL{CLEAR_TO 0x4E}3RC");
const u8 gText_Snore24BP[] = _("SNORE{CLEAR_TO 0x4E}5RC");
const u8 gText_MudSlap24BP[] = _("MUD-SLAP{CLEAR_TO 0x4E}5RC");
const u8 gText_Swift24BP[] = _("SWIFT{CLEAR_TO 0x4E}5RC");
const u8 gText_IcyWind24BP[] = _("ICY WIND{CLEAR_TO 0x4E}5RC");
const u8 gText_Endure48BP[] = _("ENDURE{CLEAR_TO 0x4E}10RC");
const u8 gText_PsychUp48BP[] = _("PSYCH UP{CLEAR_TO 0x4E}10RC");
const u8 gText_IcePunch48BP[] = _("ICE PUNCH{CLEAR_TO 0x4E}10RC");
const u8 gText_ThunderPunch48BP[] = _("THUNDERPUNCH{CLEAR_TO 0x4E}10RC");
const u8 gText_FirePunch48BP[] = _("FIRE PUNCH{CLEAR_TO 0x4E}10RC");
const u8 gText_DynamicPunch48BP[] = _("DYNAMIC PUNCH{CLEAR_TO 0x4E}10RC");
const u8 gText_DoubleEdge48BP[] = _("DOUBLE-EDGE{CLEAR_TO 0x4E}10RC");
const u8 gText_Explosion48BP[] = _("EXPLOSION{CLEAR_TO 0x4E}10RC");
const u8 gText_SleepTalk48BP[] = _("SLEEP TALK{CLEAR_TO 0x4E}10RC");
const u8 gText_Substitute48BP[] = _("SUBSTITUTE{CLEAR_TO 0x4E}10RC");
const u8 gText_Metronome48BP[] = _("METRONOME{CLEAR_TO 0x4E}10RC");
...
const u8 gText_NIDORAN_F[] = _("NIDORAN F");
const u8 gText_NIDORAN_M[] = _("NIDORAN M");
...
//rin stores
const u8 gText_MOONSTONE[] = _("Moon Stone{CLEAR_TO 0x4E}10RC");
const u8 gText_LEAFSTONE[] = _("Leaf Stone{CLEAR_TO 0x4E}10RC");
const u8 gText_FIRESTONE[] = _("Fire Stone {CLEAR_TO 0x4E}10RC");
const u8 gText_THUNDERSTONE[] = _("Thunder Stone{CLEAR_TO 0x4E}10RC");
const u8 gText_WATERSTONE[] = _("Water Stone{CLEAR_TO 0x4E}10RC");
const u8 gText_PPUP[] = _("PP Max{CLEAR_TO 0x4E}10RC");
const u8 gText_GOGOGGLES[] = _("Go Goggles{CLEAR_TO 0x4E}10RC");
const u8 gText_EXPSHARE[] = _("Exp Share{CLEAR_TO 0x4E}10RC");
const u8 gText_ACROBIKE[] = _("Acro Bike{CLEAR_TO 0x4E}10RC");
const u8 gText_MACHBIKE[] = _("Mach Bike{CLEAR_TO 0x4E}10RC");
const u8 gText_SUPERROD[] = _("Super Rod{CLEAR_TO 0x4E}10RC");
const u8 gText_TM01_FOCUS_PUNCH[] = _("FOCUS PUNCH{CLEAR_TO 0x4E}6RC");
const u8 gText_TM02_DRAGON_CLAW[] = _("DRAGON CLAW{CLEAR_TO 0x4E}6RC");
const u8 gText_TM03_WATER_PULSE[] = _("WATER PULSE{CLEAR_TO 0x4E}6RC");
const u8 gText_TM04_CALM_MIND[] = _("CALM MIND{CLEAR_TO 0x4E}6RC");
const u8 gText_TM05_ROAR[] = _("ROAR{CLEAR_TO 0x4E}6RC");
const u8 gText_TM06_TOXIC[] = _("TOXIC{CLEAR_TO 0x4E}6RC");
const u8 gText_TM07_HAIL[] = _("HAIL{CLEAR_TO 0x4E}6RC");
const u8 gText_TM08_BULK_UP[] = _("BULK UP{CLEAR_TO 0x4E}6RC");
const u8 gText_TM09_BULLET_SEED[] = _("BULLET SEED{CLEAR_TO 0x4E}6RC");
const u8 gText_TM10_HIDDEN_POWER[] = _("HIDDEN POWER{CLEAR_TO 0x4E}6RC");
const u8 gText_TM11_SUNNY_DAY[] = _("SUNNY DAY{CLEAR_TO 0x4E}6RC");
const u8 gText_TM12_TAUNT[] = _("TAUNT{CLEAR_TO 0x4E}6RC");
const u8 gText_TM13_ICE_BEAM[] = _("ICE BEAM{CLEAR_TO 0x4E}6RC");
const u8 gText_TM14_BLIZZARD[] = _("BLIZZARD{CLEAR_TO 0x4E}6RC");
const u8 gText_TM15_HYPER_BEAM[] = _("HYPER BEAM{CLEAR_TO 0x4E}6RC");
const u8 gText_TM16_LIGHT_SCREEN[] = _("LIGHT SCREEN{CLEAR_TO 0x4E}6RC");
const u8 gText_TM17_PROTECT[] = _("PROTECT{CLEAR_TO 0x4E}6RC");
const u8 gText_TM18_RAIN_DANCE[] = _("RAIN DANCE{CLEAR_TO 0x4E}6RC");
const u8 gText_TM19_GIGA_DRAIN[] = _("GIGA DRAIN{CLEAR_TO 0x4E}6RC");
const u8 gText_TM20_SAFEGUARD[] = _("SAFEGUARD{CLEAR_TO 0x4E}6RC");
const u8 gText_TM21_FRUSTRATION[] = _("FRUSTRATION{CLEAR_TO 0x4E}6RC");
const u8 gText_TM22_SOLAR_BEAM[] = _("SOLAR BEAM{CLEAR_TO 0x4E}6RC");
const u8 gText_TM23_IRON_TAIL[] = _("IRON TAIL{CLEAR_TO 0x4E}6RC");
const u8 gText_TM24_THUNDERBOLT[] = _("THUNDERBOLT{CLEAR_TO 0x4E}6RC");
const u8 gText_TM25_THUNDER[] = _("THUNDER{CLEAR_TO 0x4E}6RC");
const u8 gText_TM26_EARTHQUAKE[] = _("EARTHQUAKE{CLEAR_TO 0x4E}6RC");
const u8 gText_TM27_RETURN[] = _("RETURN{CLEAR_TO 0x4E}6RC");
const u8 gText_TM28_DIG[] = _("DIG{CLEAR_TO 0x4E}6RC");
const u8 gText_TM29_PSYCHIC[] = _("PSYCHIC{CLEAR_TO 0x4E}6RC");
const u8 gText_TM30_SHADOW_BALL[] = _("SHADOW BALL{CLEAR_TO 0x4E}6RC");
const u8 gText_TM31_BRICK_BREAK[] = _("BRICK BREAK{CLEAR_TO 0x4E}6RC");
const u8 gText_TM32_DOUBLE_TEAM[] = _("DOUBLE TEAM{CLEAR_TO 0x4E}6RC");
const u8 gText_TM33_REFLECT[] = _("REFLECT{CLEAR_TO 0x4E}6RC");
const u8 gText_TM34_SHOCK_WAVE[] = _("SHOCK WAVE{CLEAR_TO 0x4E}6RC");
const u8 gText_TM35_FLAMETHROWER[] = _("FLAMETHROWER{CLEAR_TO 0x4E}6RC");
const u8 gText_TM36_SLUDGE_BOMB[] = _("SLUDGE BOMB{CLEAR_TO 0x4E}6RC");
const u8 gText_TM37_SANDSTORM[] = _("SANDSTORM{CLEAR_TO 0x4E}6RC");
const u8 gText_TM38_FIRE_BLAST[] = _("FIRE BLAST{CLEAR_TO 0x4E}6RC");
const u8 gText_TM39_ROCK_TOMB[] = _("ROCK TOMB{CLEAR_TO 0x4E}6RC");
const u8 gText_TM40_AERIAL_ACE[] = _("AERIAL ACE{CLEAR_TO 0x4E}6RC");
const u8 gText_TM41_TORMENT[] = _("TORMENT{CLEAR_TO 0x4E}6RC");
const u8 gText_TM42_FACADE[] = _("FACADE{CLEAR_TO 0x4E}6RC");
const u8 gText_TM43_SECRET_POWER[] = _("SECRET POWER{CLEAR_TO 0x4E}6RC");
const u8 gText_TM44_REST[] = _("REST{CLEAR_TO 0x4E}6RC");
const u8 gText_TM45_ATTRACT[] = _("ATTRACT{CLEAR_TO 0x4E}6RC");
const u8 gText_TM46_THIEF[] = _("THIEF{CLEAR_TO 0x4E}6RC");
const u8 gText_TM47_STEEL_WING[] = _("STEEL WING{CLEAR_TO 0x4E}6RC");
const u8 gText_TM48_SKILL_SWAP[] = _("SKILL SWAP{CLEAR_TO 0x4E}6RC");
const u8 gText_TM49_SNATCH[] = _("SNATCH{CLEAR_TO 0x4E}6RC");
const u8 gText_TM50_OVERHEAT[] = _("OVERHEAT{CLEAR_TO 0x4E}6RC");
const u8 gText_ITEM_HM01_CUT[] = _("CUT{CLEAR_TO 0x4E}6RC");
const u8 gText_HM02_FLY[] = _("FLY{CLEAR_TO 0x4E}6RC");
const u8 gText_HM03_SURF[] = _("SURF{CLEAR_TO 0x4E}6RC");
const u8 gText_HM04_STRENGTH[] = _("STRENGTH{CLEAR_TO 0x4E}6RC");
const u8 gText_HM05_FLASH[] = _("FLASH{CLEAR_TO 0x4E}6RC");
const u8 gText_HM06_ROCK_SMASH[] = _("ROCK SMASH{CLEAR_TO 0x4E}6RC");
const u8 gText_HM07_WATERFALL[] = _("WATERFALL{CLEAR_TO 0x4E}6RC");
const u8 gText_HM08_DIVE[] = _("DIVE{CLEAR_TO 0x4E}6RC");

//rin tournies

const u8 gText_AMATEUR_OPEN[] = _("AMATEUR OPEN");
const u8 gText_RIN_INVITATIONAL[] = _("RIN INVITATIONAL");
const u8 gText_RIN_RUMBLE[] = _("RIN RUMBLE");
const u8 gText_ACE_LEAGUE_I[] = _("ACE LEAGUE");
const u8 gText_ACE_LEAGUE_II[] = _("ACE LEAGUE II");
const u8 gText_ELITE_SERIES[] = _("ELITE SERIES");
const u8 gText_MASTER_SERIES[] = _("MASTER SERIES");
const u8 gText_GRAND_MASTER_SERIES[] = _("GRANDMASTER SERIES");