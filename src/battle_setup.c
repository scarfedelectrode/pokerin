...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
	...
	[REMATCH_LAWRENCE] = REMATCH(TRAINER_SAWYER_1, TRAINER_SAWYER_1, TRAINER_SAWYER_1, TRAINER_SAWYER_1, TRAINER_SAWYER_1, BLABYRINTH_ARENA),
	[REMATCH_NATALIE] = REMATCH(TRAINER_GRUNT_AQUA_HIDEOUT_1, TRAINER_GRUNT_AQUA_HIDEOUT_1, TRAINER_GRUNT_AQUA_HIDEOUT_1, TRAINER_GRUNT_AQUA_HIDEOUT_1, TRAINER_GRUNT_AQUA_HIDEOUT_1, BLABYRINTH_ARENA),
	[REMATCH_COLIN] = REMATCH(TRAINER_GRUNT_AQUA_HIDEOUT_4, TRAINER_GRUNT_AQUA_HIDEOUT_4, TRAINER_GRUNT_AQUA_HIDEOUT_4, TRAINER_GRUNT_AQUA_HIDEOUT_4, TRAINER_GRUNT_AQUA_HIDEOUT_4, BLABYRINTH_ARENA),
	[REMATCH_HANNA1] = REMATCH(TRAINER_GRUNT_AQUA_HIDEOUT_2, TRAINER_GRUNT_AQUA_HIDEOUT_2, TRAINER_GRUNT_AQUA_HIDEOUT_2, TRAINER_GRUNT_AQUA_HIDEOUT_2, TRAINER_GRUNT_AQUA_HIDEOUT_2, BLABYRINTH_ARENA),
	[REMATCH_HOWARD1] = REMATCH(TRAINER_GRUNT_AQUA_HIDEOUT_3, TRAINER_GRUNT_AQUA_HIDEOUT_3, TRAINER_GRUNT_AQUA_HIDEOUT_3, TRAINER_GRUNT_AQUA_HIDEOUT_3, TRAINER_GRUNT_AQUA_HIDEOUT_3, BLABYRINTH_ARENA),
};
